...
export function GregorianCalendar({ dates, onDateSelect }: GregorianCalendarProps) {
  ...
  // Get the weekday of the first date to determine padding
        ...
        {paddedDates.map((date, index) => {
          ...
          return (
            <button
              ...
              aria-label={`${date.gregorian.weekday}, ${date.gregorian.monthName} ${date.gregorian.day}, ${date.gregorian.year}. Hijri: ${date.hijri.day} ${date.hijri.monthName} ${date.hijri.year}`}
